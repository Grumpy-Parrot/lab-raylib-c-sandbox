...
void on_frame()
{
    ...
    Rectangle source = {0, 0, static_cast<float>(splashTexture->width), static_cast<float>(splashTexture->height)};
    ...
    DrawText("Welcome to Grumpy Parrot!",
             GetScreenWidth() / 2 - MeasureText("Welcome to Grumpy Parrot!", 20) / 2, (int)(imagePosition.y + scaledHeight + 20), 20, BLACK);
